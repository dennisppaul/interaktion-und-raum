...
2 sucht euch einen arbeitstitel.
...
### # Schlüsselwörter# * Psychogeographie
* …

### # Archive + Aggregation# Interior and Architecture
* Frame Mag [ http://www.frame-digital.com ]
* Plot Mag [ http://www.plotmag.com ]
* …
...
# Teilnehmer
### Studierende# Denine Thode [mailto:d.thode@hfk-bremen.de]
# Marcel Helmer
...
# Jonas Otto
# Henrik Nieratschker
# Vanessa Dreier [mailto:v.dreier@hfk-bremen.de]
# Florian Born [mailto:f.born@hfk-bremen.de]
# Michael Berndt [mailto:m.berndt@hfk-bremen.de]
# Dennis Siegel [mailto:uni@dennissiegel.de]
# Svetlana Willer

To send messages to the participants use this email address: [mailto:temporaere-raeume@googlegroups.com temporaere-raeume@googlegroups.com].
